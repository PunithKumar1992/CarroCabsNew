...
<img src="images/about-img1.png" alt="" class="img-circle">
</figure>
</div>
...
<p>CARRO is knowing and fullfilling all the moving needs of their clients.We have been professional service since many years ,and we have developed one services in a waay that cater to both implicit and explicit needs of our clients. </p>
<p>Our professional carrier services offer cost effective and personalised services.We ensure fixed,timely and cost effective door step services where we pickup from the client place and drop exactly where they wish. </p>
...
<h2 style="color: white;">CARRO <span  style="color: white;"> Drivers For Hire</span></h2>
</div>
<div class="row">
...
<h4><a href="booking.html">Driver1</a></h4>
...
<figcaption class="cp-caption">
<h4><a href="booking.html">Driver2</a></h4>
<ul class="cp-meta-listed">
...
<figcaption class="cp-caption">
<h4><a href="booking.html">Driver4</a></h4>
<ul class="cp-meta-listed">
...
<figcaption class="cp-caption">
 <h4><a href="booking.html">Driver5</a></h4>
<ul class="cp-meta-listed">
<li>Cab: <span>Driver</span></li>
