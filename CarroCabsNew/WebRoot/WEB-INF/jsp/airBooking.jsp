...
<% 
aircar = session.getAttribute("aircar").toString();
airsource=session.getAttribute("airsource").toString();
airdestination=session.getAttribute("airdestination").toString();
airbasicamt=session.getAttribute("airbasicamt").toString();
airgst=session.getAttribute("airgst").toString();
airtotal=session.getAttribute("airtotal").toString();
...
out.println("<form action='airportFinal.html' method='post'>");
...
out.println("<td style='border:none;'>" +aircar+"</td>");
out.println("</tr>");
out.println("<br>");

out.println("<tr>");
out.println("<th style='border:none;'>Pickup Point:</th>" );
out.println("<td style='border:none;'>" +airsource+"</td>");
out.println("</tr>");


out.println("<tr>");
out.println("<th style='border:none;'>Distination Point:</th>" );
out.println("<td style='border:none;'>" +airdestination+"</td>");
out.println("</tr>");

out.println("<tr>");
out.println("<th style='border:none;'>Basic Amount:</th>" );
out.println("<td style='border:none;'>" +airbasicamt+"</td>");
out.println("</tr>");

out.println("<tr>");
out.println("<th style='border:none;'>Gst Amount:</th>" );
out.println("<td style='border:none;'>" +airgst+"</td>");
out.println("</tr>");


out.println("<tr>");
out.println("<th style='border:none;'>Toatl <b>Approx.</b> Amount:</th>" );
out.println("<td style='border:none;'>" +airtotal+"</td>");
out.println("</tr>");
out.println("</table>");
