...
<h3 class="tittle1" style="font-size:35px;color: black;text-decoration:justify;">Mysore Coorg 3Days 2Night Package</h3>
</div>
<div class="row">
<div class="col-md-12">
<div class="col-md-6">
 
<div class="cp-faq-holder" style="margin-top:-1%;">		
...
Tippu summer palace, Gumbaz,Ranganathatemple, Chamundi hills, Nandi statue,Zoo, Mysore palace, Jaganmohan palace, Church, Old st, marry chruch, Brundavan garden.
</li>
<li><br></li>
<li><b style="font-size: 30px;">Coorg</b></li>
<li><br></li>
<li style="text-align: justify;">
Golden temple, Nisargadhama, Dubare falls, Raja seat, Thalakaveri, Habbi falls, Fort.</li>
<li><br></li>
<li><br></li>
</ul>
 <center>
<a href="PackCarList.html" class="cp-btn-style2" style="float: left">Book Now</a></center> 
</form>
</div>
</div>
</div>
...
<h3 class="tittle1" style="font-size:35px;color: white;text-decoration:justify;">Mysore Coorg 3Days 2Night Package</h3>
<style>
...
/* Position the image gal (needed to position the left and right arrows) */
.gal {
  position: relative;
  width:100%;
  margin-top:-6%;
...
<div class="gal">
  <div class="mySlides">
    ...
    <img src="images/ooty.png" style="width:100%;height:378px;">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 6</div>
    <img src="images/coorg.png" style="width:100%;height:378px;">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 6</div>
    <img src="Goa.png" style="width:100%;height:378px;">
  </div>
  ...
  <div class="mySlides">
    ...
    <img src="images/coorg.png" style="width:100%;">
  </div>
    
  <div class="mySlides">
    <div class="numbertext">6 / 6</div>
    <img src="images/ooty.png" style="width:100%;">
  </div>
    
  <a class="prev" onclick="plusSlides(-1)">❮</a>
  <a class="next" onclick="plusSlides(1)">❯</a>

  <div class="caption-gal">
    <p id="caption"></p>
  </div>

  <div class="row">
    <div class="column">
      <img class="demo cursor" src="images/ooty.png" style="width:100%;" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="images/coorg.png" style="width:100%;" onclick="currentSlide(2)" alt="Trolltunga, Norway">
    </div>
    <div class="column">
      <img class="demo cursor" src="images/coorg.png" style="width:100%;" onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
    <div class="column">
      <img class="demo cursor" src="images/ooty.png" style="width:100%;" onclick="currentSlide(4)" alt="Northern Lights">
    </div>
    <div class="column">
      <img class="demo cursor" src="images/coorg.png" style="width:100%;" onclick="currentSlide(5)" alt="Nature and sunrise">
    </div>    
    <div class="column">
      <img class="demo cursor" src="images/coorg.png" style="width:100%;" onclick="currentSlide(6)" alt="Snowy Mountains">
    </div>
  </div>
</div>
...
<section>
<div class="col-md-12" >
<center><h1>Other Pacakages</h1></center>
<marquee direction="left" loop>
<div class="col-md-3" style="width:25%;">
<figure class="cp-gallery-box" style="height: 250px">
