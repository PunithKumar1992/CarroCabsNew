...
<img src="images/banner/inner-banner-img-11.jpg" alt="">
...
<ul class="breadcrumb">
<li><a href="index.jsp">Home</a></li>
<li class="active" style="color: white;">Terms and Conditions</li>
</ul>
</div>
</div>
...
<body class="cp-testimonial-section pd-tb80">

<div class=" col-md-12" style="margin-top: 5%;margin-bottom: 5%;">
<div class="cp-heading-style1">
<h3 style="color: white;">Terms And<span  style="color: white;">Conditions</span></h3>
</div>
<div class="col-md-6">
<img src="images/carse.png" style="width: 97%;">
</div>
<div class="col-md-6">
<p style="color:white;margin-top:5%;text-align: justify;">Pay online</p>
<p style="color:white;margin-top:5%;text-align: justify;">20% Advance payment</p>
<p style="color:white;margin-top:5%;text-align: justify;">One Way Minimum Kilometers 150Km</p>
<p style="color:white;margin-top:5%;text-align: justify;">Round Trip Minimum Kilometers 250Km</p>
<p style="color:white;margin-top:5%;text-align: justify;">Extra: Interstate Tax, Toll &amp; Parking</p>
<p style="color:white;margin-top:5%;text-align: justify;">Package Fare/KMS are approximate</p>
<p style="color:white;margin-top:5%;text-align: justify;">Midnight to Midnight is a Day</p>
<p style="color:white;margin-top:5%;text-align: justify;">Cab booked for Outstation cannot be used within city travel</p>
<p style="color:white;margin-top:5%;text-align: justify;">Free cancellation</p>
<p style="color:white;margin-top:5%;text-align: justify;">24 hours Considerd a day</p>
<p style="color:white;margin-top:5%;text-align: justify;">A/C switch of for hills stations<p>
</div>
</div>
</body>
