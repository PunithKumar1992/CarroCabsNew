...
<li><a href="dregistration.html">Driver Registration</a></li>
</ul>
</li>
...
<ul class="breadcrumb">
<li><a href="index.jsp">Home</a></li>
<li class="active" style="color: white;">Write Review</li>
</ul>
</div>
</div>
...
<h2><span>Write Review</span></h2>
</div>

<div class="cp-reservation-box cp-login-box col-md-12">
<h3>Please enter to Write Review</h3>
<form action="" method="post">
<div class="col-md-7" style="margin-left:20%">
<div class="inner-holder ">
<input type="text" placeholder="Rate Me" name="name" required pattern="[a-zA-Z ]+">
</div>
<div class="inner-holder ">
...
<input type="text" placeholder="Title of Your Review" name="name" required pattern="[a-zA-Z ]+">
</div>
<div class="inner-holder ">
<input type="text" placeholder="Your Review" name="name" required pattern="[a-zA-Z ]+">
</div>
</div>
<div class="col-md-7" style="margin-left:20%">
<select style="    width: 20%;PADDING: 0.7EM;MARGIN-RIGHT: 20%;">
<option>What sort of trip was this?</option>
<option>One Day Package</option>
<option> Package Tour</option>
<option>Corporate Tour</option>
<option>Airport pickup/drop</option>
</select>
<select>
<option>When did you travel?</option>
...
<strong class="logo">
<a href="index.jsp"><img src="images/cp-logo2.png" alt=""></a>
</strong>
