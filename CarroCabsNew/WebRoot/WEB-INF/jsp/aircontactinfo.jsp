...
<input type="text" placeholder="Full Name" name="airfullname" required pattern="[a-zA-Z ]+">
</div>
<div class="inner-holder">

<input type="text" placeholder="Phone Number" name="airphone" required pattern="[789][0-9]{9}">
</div>
<div class="inner-holder">

<input type="text" placeholder="Email" name="airemail" required pattern="^[a-zA-Z0-9-\_.]+@[a-zA-Z0-9-\_.]+\.[a-zA-Z0-9.]{2,5}$">
</div>
<div class="inner-holder">
