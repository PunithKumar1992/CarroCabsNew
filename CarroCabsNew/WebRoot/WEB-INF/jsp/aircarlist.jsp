<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.appfone.carro.Daoimpl.Airvehicle_listDaoimpl" %>
...
<h2><br>Choose  <span> CAR</span></h2>
</div>
<% 
Airvehicle_listDaoimpl v_list= new Airvehicle_listDaoimpl();
...
base_price = new String[count];
base_price=v_list.getBasicamtlist();

gst=new String[count];
gst=v_list.getgstlist();

total=new String[count];
total=v_list.gettotallist();
...
out.println("<form action='Aircontactinfo.html' method='post'>");
...
out.println("<li>Base Price: <span>"+base_price[i]+"</span></li>");
out.println("<li>Gst: <strong>"+gst[i]+"</strong></li>");
out.println("<li>Total Amount: <strong>"+total[i]+" </strong></li>");

out.println("</ul>");
out.println("<input type='hidden' value='"+v_name[i]+"' name='aircar'>");
out.println("<input type='hidden' value='"+base_price[i]+"' name='airbasicamt'>");
out.println("<input type='hidden' value='"+gst[i]+"' name='airgst'>");
out.println("<input type='hidden' value='"+total[i]+"' name='airtotal'>");
out.println("<input type='hidden' value='"+v_image[i]+"' name='airvimage'>");
